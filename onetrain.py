...
def main():
    ...
    group_ops.add_argument('--save', required=False, type=int, help='save n intermittent steps')
    group_ops.add_argument('--backup', required=False, type=int, help='create n training backups')
    ...
    group_params.add_argument("--gradient", default=False, action='store_true', help='use gradient checkpointing')
